...
def timediff(t1, t2):
    ...
    # To get absolute value check if t2 is greate than t1
    if t2 > t1:
...
def dateTimeDiff2(start,end,unit):
    ...
    Args:
        ...
        unit (_type_): name of time unit: day,hour,minute or second
...
def finnishWeekdayOrder(weekday):
    weekdayNumber = {"maanantai":1,"tiistai":2,"keskiviikko":3,"torstai":4,
                    "perjantai":5,"lauantai":6,"sunnuntai":7}    
    try:
